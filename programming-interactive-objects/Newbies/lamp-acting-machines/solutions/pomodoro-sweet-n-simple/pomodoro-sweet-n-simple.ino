...
#include <FastLED.h> // Here we use the FastLED library for controlling LEDs
...
unsigned long work_duration = 10000; // 10 seconds for quick testing, for real use 1200000 = 20*60*1000 = 20 minutes
